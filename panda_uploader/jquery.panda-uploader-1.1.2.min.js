var a,swfobject=function(){function b(){if(!D){try{var d=n.getElementsByTagName("body")[0].appendChild(z("span"));d.parentNode.removeChild(d)}catch(e){return}D=true;d=L.length;for(var g=0;g<d;g++)L[g]()}}function c(d){if(D)d();else L[L.length]=d}function f(d){if(typeof u.addEventListener!=p)u.addEventListener("load",d,false);else if(typeof n.addEventListener!=p)n.addEventListener("load",d,false);else if(typeof u.attachEvent!=p)fa(u,"onload",d);else if(typeof u.onload=="function"){var e=u.onload;u.onload=
...
A[e].id,h=A[e].callbackFn,i={success:false,id:g};if(j.pv[0]>0){var l=v(g);if(l)if(N(A[e].swfVersion)&&!(j.wk&&j.wk<312)){E(g,true);if(h){i.success=true;i.ref=t(g);h(i)}}else if(A[e].expressInstall&&G()){i={};i.data=A[e].expressInstall;i.width=l.getAttribute("width")||"0";i.height=l.getAttribute("height")||"0";if(l.getAttribute("class"))i.styleclass=l.getAttribute("class");if(l.getAttribute("align"))i.align=l.getAttribute("align");var m={};l=l.getElementsByTagName("param");for(var q=l.length,r=0;r<
q;r++)if(l[r].getAttribute("name").toLowerCase()!="movie")m[l[r].getAttribute("name")]=l[r].getAttribute("value");O(i,m,g,h)}else{P(l);h&&h(i)}}else{E(g,true);if(h){if((g=t(g))&&typeof g.SetVariable!=p){i.success=true;i.ref=g}h(i)}}}}function t(d){var e=null;if((d=v(d))&&d.nodeName=="OBJECT")if(typeof d.SetVariable!=p)e=d;else if(d=d.getElementsByTagName(w)[0])e=d;return e}function G(){return!Q&&N("6.0.65")&&(j.win||j.mac)&&!(j.wk&&j.wk<312)}function O(d,e,g,h){Q=true;W=h||null;$={success:false,id:g};
var i=v(g);if(i){if(i.nodeName=="OBJECT"){I=J(i);R=null}else{I=i;R=g}d.id=aa;if(typeof d.width==p||!/%$/.test(d.width)&&parseInt(d.width,10)<310)d.width="310";if(typeof d.height==p||!/%$/.test(d.height)&&parseInt(d.height,10)<137)d.height="137";n.title=n.title.slice(0,47)+" - Flash Player Installation";h=j.ie&&j.win?"ActiveX":"PlugIn";h="MMredirectURL="+u.location.toString().replace(/&/g,"%26")+"&MMplayerType="+h+"&MMdoctitle="+n.title;if(typeof e.flashvars!=p)e.flashvars+="&"+h;else e.flashvars=
h;if(j.ie&&j.win&&i.readyState!=4){h=z("div");g+="SWFObjectNew";h.setAttribute("id",g);i.parentNode.insertBefore(h,i);i.style.display="none";(function(){i.readyState==4?i.parentNode.removeChild(i):setTimeout(arguments.callee,10)})()}F(d,e,g)}}function P(d){if(j.ie&&j.win&&d.readyState!=4){var e=z("div");d.parentNode.insertBefore(e,d);e.parentNode.replaceChild(J(d),e);d.style.display="none";(function(){d.readyState==4?d.parentNode.removeChild(d):setTimeout(arguments.callee,10)})()}else d.parentNode.replaceChild(J(d),
d)}function J(d){var e=z("div");if(j.win&&j.ie)e.innerHTML=d.innerHTML;else if(d=d.getElementsByTagName(w)[0])if(d=d.childNodes)for(var g=d.length,h=0;h<g;h++)!(d[h].nodeType==1&&d[h].nodeName=="PARAM")&&d[h].nodeType!=8&&e.appendChild(d[h].cloneNode(true));return e}function F(d,e,g){var h,i=v(g);if(j.wk&&j.wk<312)return h;if(i){if(typeof d.id==p)d.id=g;if(j.ie&&j.win){var l="";for(var m in d)if(d[m]!=Object.prototype[m])if(m.toLowerCase()=="data")e.movie=d[m];else if(m.toLowerCase()=="styleclass")l+=
...
Object.prototype[r]&&r.toLowerCase()!="movie"&&X(q,r,e[r]);i.parentNode.replaceChild(q,i);h=q}}return h}function X(d,e,g){var h=z("param");h.setAttribute("name",e);h.setAttribute("value",g);d.appendChild(h)}function ba(d){var e=v(d);if(e&&e.nodeName=="OBJECT")if(j.ie&&j.win){e.style.display="none";(function(){e.readyState==4?ga(d):setTimeout(arguments.callee,10)})()}else e.parentNode.removeChild(e)}function ga(d){if(d=v(d)){for(var e in d)if(typeof d[e]=="function")d[e]=null;d.parentNode.removeChild(d)}}
function v(d){var e=null;try{e=n.getElementById(d)}catch(g){}return e}function z(d){return n.createElement(d)}function fa(d,e,g){d.attachEvent(e,g);H[H.length]=[d,e,g]}function N(d){var e=j.pv;d=d.split(".");d[0]=parseInt(d[0],10);d[1]=parseInt(d[1],10)||0;d[2]=parseInt(d[2],10)||0;return e[0]>d[0]||e[0]==d[0]&&e[1]>d[1]||e[0]==d[0]&&e[1]==d[1]&&e[2]>=d[2]?true:false}function ca(d,e,g,h){if(!(j.ie&&j.mac)){var i=n.getElementsByTagName("head")[0];if(i){g=g&&typeof g=="string"?g:"screen";if(h)Y=x=null;
if(!x||Y!=g){h=z("style");h.setAttribute("type","text/css");h.setAttribute("media",g);x=i.appendChild(h);if(j.ie&&j.win&&typeof n.styleSheets!=p&&n.styleSheets.length>0)x=n.styleSheets[n.styleSheets.length-1];Y=g}if(j.ie&&j.win)x&&typeof x.addRule==w&&x.addRule(d,e);else x&&typeof n.createTextNode!=p&&x.appendChild(n.createTextNode(d+" {"+e+"}"))}}}function E(d,e){if(da){e=e?"visible":"hidden";if(D&&v(d))v(d).style.visibility=e;else ca("#"+d,"visibility:"+e)}}function ea(d){return/[\"<>.;]/.exec(d)!=
null&&typeof encodeURIComponent!=p?encodeURIComponent(d):d}var p="undefined",w="object",M="application/x-shockwave-flash",aa="SWFObjectExprInst",u=window,n=document,B=navigator,Z=false,L=[k],A=[],S=[],H=[],I,R,W,$,D=false,Q=false,x,Y,da=true,j=function(){var d=typeof n.getElementById!=p&&typeof n.getElementsByTagName!=p&&typeof n.createElement!=p,e=B.userAgent.toLowerCase(),g=B.platform.toLowerCase(),h=g?/win/.test(g):/win/.test(e);g=g?/mac/.test(g):/mac/.test(e);e=/webkit/.test(e)?parseFloat(e.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
"$1")):false;var i=!+"\u000b1",l=[0,0,0],m=null;if(typeof B.plugins!=p&&typeof B.plugins["Shockwave Flash"]==w){if((m=B.plugins["Shockwave Flash"].description)&&!(typeof B.mimeTypes!=p&&B.mimeTypes[M]&&!B.mimeTypes[M].enabledPlugin)){Z=true;i=false;m=m.replace(/^.*\s+(\S+\s+\S+$)/,"$1");l[0]=parseInt(m.replace(/^(.*)\..*$/,"$1"),10);l[1]=parseInt(m.replace(/^.*\.(.*)\s.*$/,"$1"),10);l[2]=/[a-zA-Z]/.test(m)?parseInt(m.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0}}else if(typeof u.ActiveXObject!=p)try{var q=
new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(q)if(m=q.GetVariable("$version")){i=true;m=m.split(" ")[1].split(",");l=[parseInt(m[0],10),parseInt(m[1],10),parseInt(m[2],10)]}}catch(r){}return{w3:d,pv:l,wk:e,ie:i,win:h,mac:g}}();(function(){if(j.w3){if(typeof n.readyState!=p&&n.readyState=="complete"||typeof n.readyState==p&&(n.getElementsByTagName("body")[0]||n.body))b();if(!D){typeof n.addEventListener!=p&&n.addEventListener("DOMContentLoaded",b,false);if(j.ie&&j.win){n.attachEvent("onreadystatechange",
function(){if(n.readyState=="complete"){n.detachEvent("onreadystatechange",arguments.callee);b()}});u==top&&function(){if(!D){try{n.documentElement.doScroll("left")}catch(d){setTimeout(arguments.callee,0);return}b()}}()}j.wk&&function(){D||(/loaded|complete/.test(n.readyState)?b():setTimeout(arguments.callee,0))}();f(b)}}})();(function(){j.ie&&j.win&&window.attachEvent("onunload",function(){for(var d=H.length,e=0;e<d;e++)H[e][0].detachEvent(H[e][1],H[e][2]);d=S.length;for(e=0;e<d;e++)ba(S[e]);for(var g in j)j[g]=
null;j=null;for(var h in swfobject)swfobject[h]=null;swfobject=null})})();return{registerObject:function(d,e,g,h){if(j.w3&&d&&e){var i={};i.id=d;i.swfVersion=e;i.expressInstall=g;i.callbackFn=h;A[A.length]=i;E(d,false)}else h&&h({success:false,id:d})},getObjectById:function(d){if(j.w3)return t(d)},embedSWF:function(d,e,g,h,i,l,m,q,r,K){var T={success:false,id:e};if(j.w3&&!(j.wk&&j.wk<312)&&d&&e&&g&&h&&i){E(e,false);c(function(){g+="";h+="";var C={};if(r&&typeof r===w)for(var y in r)C[y]=r[y];C.data=
d;C.width=g;C.height=h;y={};if(q&&typeof q===w)for(var U in q)y[U]=q[U];if(m&&typeof m===w)for(var V in m)if(typeof y.flashvars!=p)y.flashvars+="&"+V+"="+m[V];else y.flashvars=V+"="+m[V];if(N(i)){U=F(C,y,e);C.id==e&&E(e,true);T.success=true;T.ref=U}else if(l&&G()){C.data=l;O(C,y,e,K);return}else E(e,true);K&&K(T)})}else K&&K(T)},switchOffAutoHideShow:function(){da=false},ua:j,getFlashPlayerVersion:function(){return{major:j.pv[0],minor:j.pv[1],release:j.pv[2]}},hasFlashPlayerVersion:N,createSWF:function(d,
e,g){if(j.w3)return F(d,e,g)},showExpressInstall:function(d,e,g,h){j.w3&&G()&&O(d,e,g,h)},removeSWF:function(d){j.w3&&ba(d)},createCSS:function(d,e,g,h){j.w3&&ca(d,e,g,h)},addDomLoadEvent:c,addLoadEvent:f,getQueryParamValue:function(d){var e=n.location.search||n.location.hash;if(e){if(/\?/.test(e))e=e.split("?")[1];if(d==null)return ea(e);e=e.split("&");for(var g=0;g<e.length;g++)if(e[g].substring(0,e[g].indexOf("="))==d)return ea(e[g].substring(e[g].indexOf("=")+1))}return""},expressInstallCallback:function(){if(Q){var d=
v(aa);if(d&&I){d.parentNode.replaceChild(I,d);if(R){E(R,true);if(j.ie&&j.win)I.style.display="block"}W&&W($)}Q=false}}}}(),SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};
...
PandaUploader.bind=function(b,c){return function(){var f=b[c];if(f)return f.apply(b,arguments)}};PandaUploader.alert=function(b){return alert(b)};PandaUploader.parseJSON=function(b){return jQuery&&jQuery.parseJSON?jQuery.parseJSON(b):eval("("+b+")")};PandaUploader.toJSON=function(b){function c(k){return k.replace(new RegExp('"',"g"),'\\"')}var f=[];jQuery.each(b,function(k,o){f.push('"'+c(k)+'":"'+c(o)+'"')});return"{"+f.join(",")+"}"};PandaUploader.BaseWidget=function(){};
...
"/videos.json",file_size_limit:0,file_types:this.allowedFileTypes(),file_types_description:"All Files",file_upload_limit:0,flash_url:this.options.uploader_dir+"/swfupload.swf",button_image_url:this.options.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:c,file_post_name:"file",debug:false},this.swfupload_options));this.swfupload.bind("swfuploadLoaded",this.boundHandler("onwidgetload"));this.swfupload.bind("fileQueued",PandaUploader.bind(this,"fileQueued"));
...
a.uploadStart=function(){this.swfupload.data("__swfu").setPostParams(this.getSignedParams());this.triggerEvent("onloadstart")};a.uploadProgress=function(b,c,f,k){b.loaded=f;b.total=k;this.triggerEvent("onprogress",[b])};a.uploadSuccess=function(b,c,f){this.setValue(PandaUploader.parseJSON(f).id);b={target:{status:"200",responseText:f}};this.triggerEvent("onreadystatechange",[b]);this.triggerEvent("onsuccess",[b])};
a.uploadError=function(b,c,f,k){function o(t){return{type:"error",timeStamp:t.timeStamp}}function s(t){return{name:t.name,size:t.size,type:t.type}}this.triggerEvent("onerror",[o(b,k),s(c)])};a.getFile=function(){return this.file};a.start=function(){return this.swfupload.swfupload("startUpload")};a.disable=function(){return this.swfupload.swfupload("setButtonDisabled",true)};a.enable=function(){return this.swfupload.swfupload("setButtonDisabled",false)};
...
a.start=function(){var b=this.getFile(),c=PandaUploader.toJSON(this.getSignedParams());this.xhr.open("POST",this.options.api_url+"/videos.json",true);this.xhr.setRequestHeader("Cache-Control","no-cache");this.xhr.setRequestHeader("Content-Type","application/octet-stream");this.xhr.setRequestHeader("X-Requested-With","XMLHttpRequest");this.xhr.setRequestHeader("X-File-Name",b.name||b.fileName);this.xhr.setRequestHeader("X-Query-Params",c);this.bindRSCEvent();this.errorFaked=false;"name"in b?this.xhr.send(b):
this.xhr.sendAsBinary(b.getAsBinary())};a.abort=function(){this.xhr.abort()};a.getFile=function(){return jQuery(this.getField()).get(0).files[0]};a.setValue=function(b){return this.query.val(b)};a.disable=function(){jQuery(this.getField()).attr("disabled",true)};a.enable=function(){jQuery(this.getField()).removeAttr("disabled")};a.createField=function(){this.query.after('<input type="file" />');jQuery(this.getField()).change(PandaUploader.bind(this,"onchange"))};a.getField=function(){return this.query.next().get(0)};
a.onerror=function(b){this.notifyError(b)};a.fakeError=function(){if(!this.errorFaked){this.errorFaked=true;this.notifyError({timeStamp:+new Date,type:"error"})}};a.notifyError=function(b){this.triggerEvent("onerror",[b,this.getFile()])};
a.onreadystatechange=function(b){this.triggerEvent("onreadystatechange",arguments);var c=null;try{c=b.target.status}catch(f){this.bindRSCEvent();return}if(c=="200"&&b.target.responseText){this.setValue(PandaUploader.parseJSON(b.target.responseText).id);this.triggerEvent("onsuccess",[b])}else{c!="200"&&b.target.responseText&&this.fakeError(b);this.bindRSCEvent()}};a.bindRSCEvent=function(){jQuery(this.xhr).one("readystatechange",PandaUploader.bind(this,"onreadystatechange"))};
a.onchange=function(){if(this.validateFileExtension()&&this.validateFileSize())this.triggerEvent("onchange");else{this.query.next("[type=file]").remove();this.createField()}};a.validateFileExtension=function(){var b=false,c=this;jQuery.each(this.options.allowed_extensions,function(f,k){if((new RegExp("\\."+k+"$")).test(c.getFile().fileName))b=true});b||PandaUploader.alert("You did not select a video file. Please select a valid file.");return b};
a.validateFileSize=function(){var b=(this.getFile().size||this.getFile().fileSize)<5368709120;b||PandaUploader.alert("The file you are trying to upload is too large. The limit is 5GB");return b};PandaUploader.BaseStrategy=function(){};
...
20)}},setProgress:function(c,f){if(this.progress){c=Math.ceil(f*100/this.fileSize);if(c>100)c=100;jQuery(this.progress).css("width",c+"%")}},animateBarBg:function(){this.count++;var c=this.$p.css("background-position");c=c?c.split(" "):0;if(this.count==37){this.count=0;this.$p.css("background-position",c+36+"px 0px")}else this.$p.css("background-position",c-1+"px 0px")},reset:function(){clearInterval(this.timer);jQuery(this.progress).css("width","0%");this.$p.css("display","none")}}})();
