...
function(){e();c()}}else u.onload=c}function m(){Z?f():i()}function f(){var c=p.getElementsByTagName("body")[0],e=z(w);e.setAttribute("type",M);var g=c.appendChild(e);if(g){var j=0;(function(){if(typeof g.GetVariable!=q){var k=g.GetVariable("$version");if(k){k=k.split(" ")[1].split(",");l.pv=[parseInt(k[0],10),parseInt(k[1],10),parseInt(k[2],10)]}}else if(j<10){j++;setTimeout(arguments.callee,10);return}c.removeChild(e);g=null;i()})()}else i()}function i(){var c=A.length;if(c>0)for(var e=0;e<c;e++){var g=
A[e].id,j=A[e].callbackFn,k={success:false,id:g};if(l.pv[0]>0){var n=v(g);if(n)if(N(A[e].swfVersion)&&!(l.wk&&l.wk<312)){E(g,true);if(j){k.success=true;k.ref=r(g);j(k)}}else if(A[e].expressInstall&&G()){k={};k.data=A[e].expressInstall;k.width=n.getAttribute("width")||"0";k.height=n.getAttribute("height")||"0";if(n.getAttribute("class"))k.styleclass=n.getAttribute("class");if(n.getAttribute("align"))k.align=n.getAttribute("align");var o={};n=n.getElementsByTagName("param");for(var s=n.length,t=0;t<
s;t++)if(n[t].getAttribute("name").toLowerCase()!="movie")o[n[t].getAttribute("name")]=n[t].getAttribute("value");O(k,o,g,j)}else{P(n);j&&j(k)}}else{E(g,true);if(j){if((g=r(g))&&typeof g.SetVariable!=q){k.success=true;k.ref=g}j(k)}}}}function r(c){var e=null;if((c=v(c))&&c.nodeName=="OBJECT")if(typeof c.SetVariable!=q)e=c;else if(c=c.getElementsByTagName(w)[0])e=c;return e}function G(){return!Q&&N("6.0.65")&&(l.win||l.mac)&&!(l.wk&&l.wk<312)}function O(c,e,g,j){Q=true;W=j||null;aa={success:false,
id:g};var k=v(g);if(k){if(k.nodeName=="OBJECT"){I=J(k);R=null}else{I=k;R=g}c.id=ba;if(typeof c.width==q||!/%$/.test(c.width)&&parseInt(c.width,10)<310)c.width="310";if(typeof c.height==q||!/%$/.test(c.height)&&parseInt(c.height,10)<137)c.height="137";p.title=p.title.slice(0,47)+" - Flash Player Installation";j=l.ie&&l.win?"ActiveX":"PlugIn";j="MMredirectURL="+u.location.toString().replace(/&/g,"%26")+"&MMplayerType="+j+"&MMdoctitle="+p.title;if(typeof e.flashvars!=q)e.flashvars+="&"+j;else e.flashvars=
j;if(l.ie&&l.win&&k.readyState!=4){j=z("div");g+="SWFObjectNew";j.setAttribute("id",g);k.parentNode.insertBefore(j,k);k.style.display="none";(function(){k.readyState==4?k.parentNode.removeChild(k):setTimeout(arguments.callee,10)})()}F(c,e,g)}}function P(c){if(l.ie&&l.win&&c.readyState!=4){var e=z("div");c.parentNode.insertBefore(e,c);e.parentNode.replaceChild(J(c),e);c.style.display="none";(function(){c.readyState==4?c.parentNode.removeChild(c):setTimeout(arguments.callee,10)})()}else c.parentNode.replaceChild(J(c),
c)}function J(c){var e=z("div");if(l.win&&l.ie)e.innerHTML=c.innerHTML;else if(c=c.getElementsByTagName(w)[0])if(c=c.childNodes)for(var g=c.length,j=0;j<g;j++)!(c[j].nodeType==1&&c[j].nodeName=="PARAM")&&c[j].nodeType!=8&&e.appendChild(c[j].cloneNode(true));return e}function F(c,e,g){var j,k=v(g);if(l.wk&&l.wk<312)return j;if(k){if(typeof c.id==q)c.id=g;if(l.ie&&l.win){var n="";for(var o in c)if(c[o]!=Object.prototype[o])if(o.toLowerCase()=="data")e.movie=c[o];else if(o.toLowerCase()=="styleclass")n+=
' class="'+c[o]+'"';else if(o.toLowerCase()!="classid")n+=" "+o+'="'+c[o]+'"';o="";for(var s in e)if(e[s]!=Object.prototype[s])o+='<param name="'+s+'" value="'+e[s]+'" />';k.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+n+">"+o+"</object>";S[S.length]=c.id;j=v(c.id)}else{s=z(w);s.setAttribute("type",M);for(n in c)if(c[n]!=Object.prototype[n])if(n.toLowerCase()=="styleclass")s.setAttribute("class",c[n]);else n.toLowerCase()!="classid"&&s.setAttribute(n,c[n]);for(var t in e)e[t]!=
Object.prototype[t]&&t.toLowerCase()!="movie"&&X(s,t,e[t]);k.parentNode.replaceChild(s,k);j=s}}return j}function X(c,e,g){var j=z("param");j.setAttribute("name",e);j.setAttribute("value",g);c.appendChild(j)}function ca(c){var e=v(c);if(e&&e.nodeName=="OBJECT")if(l.ie&&l.win){e.style.display="none";(function(){e.readyState==4?ha(c):setTimeout(arguments.callee,10)})()}else e.parentNode.removeChild(e)}function ha(c){if(c=v(c)){for(var e in c)if(typeof c[e]=="function")c[e]=null;c.parentNode.removeChild(c)}}
function v(c){var e=null;try{e=p.getElementById(c)}catch(g){}return e}function z(c){return p.createElement(c)}function ga(c,e,g){c.attachEvent(e,g);H[H.length]=[c,e,g]}function N(c){var e=l.pv;c=c.split(".");c[0]=parseInt(c[0],10);c[1]=parseInt(c[1],10)||0;c[2]=parseInt(c[2],10)||0;return e[0]>c[0]||e[0]==c[0]&&e[1]>c[1]||e[0]==c[0]&&e[1]==c[1]&&e[2]>=c[2]?true:false}function da(c,e,g,j){if(!(l.ie&&l.mac)){var k=p.getElementsByTagName("head")[0];if(k){g=g&&typeof g=="string"?g:"screen";if(j)Y=x=null;
if(!x||Y!=g){j=z("style");j.setAttribute("type","text/css");j.setAttribute("media",g);x=k.appendChild(j);if(l.ie&&l.win&&typeof p.styleSheets!=q&&p.styleSheets.length>0)x=p.styleSheets[p.styleSheets.length-1];Y=g}if(l.ie&&l.win)x&&typeof x.addRule==w&&x.addRule(c,e);else x&&typeof p.createTextNode!=q&&x.appendChild(p.createTextNode(c+" {"+e+"}"))}}}function E(c,e){if(ea){e=e?"visible":"hidden";if(D&&v(c))v(c).style.visibility=e;else da("#"+c,"visibility:"+e)}}function fa(c){return/[\\\"<>\.;]/.exec(c)!=
null&&typeof encodeURIComponent!=q?encodeURIComponent(c):c}var q="undefined",w="object",M="application/x-shockwave-flash",ba="SWFObjectExprInst",u=window,p=document,B=navigator,Z=false,L=[m],A=[],S=[],H=[],I,R,W,aa,D=false,Q=false,x,Y,ea=true,l=function(){var c=typeof p.getElementById!=q&&typeof p.getElementsByTagName!=q&&typeof p.createElement!=q,e=B.userAgent.toLowerCase(),g=B.platform.toLowerCase(),j=g?/win/.test(g):/win/.test(e);g=g?/mac/.test(g):/mac/.test(e);e=/webkit/.test(e)?parseFloat(e.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
"$1")):false;var k=!+"\u000b1",n=[0,0,0],o=null;if(typeof B.plugins!=q&&typeof B.plugins["Shockwave Flash"]==w){if((o=B.plugins["Shockwave Flash"].description)&&!(typeof B.mimeTypes!=q&&B.mimeTypes[M]&&!B.mimeTypes[M].enabledPlugin)){Z=true;k=false;o=o.replace(/^.*\s+(\S+\s+\S+$)/,"$1");n[0]=parseInt(o.replace(/^(.*)\..*$/,"$1"),10);n[1]=parseInt(o.replace(/^.*\.(.*)\s.*$/,"$1"),10);n[2]=/[a-zA-Z]/.test(o)?parseInt(o.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0}}else if(typeof u.ActiveXObject!=q)try{var s=
new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(s)if(o=s.GetVariable("$version")){k=true;o=o.split(" ")[1].split(",");n=[parseInt(o[0],10),parseInt(o[1],10),parseInt(o[2],10)]}}catch(t){}return{w3:c,pv:n,wk:e,ie:k,win:j,mac:g}}();(function(){if(l.w3){if(typeof p.readyState!=q&&p.readyState=="complete"||typeof p.readyState==q&&(p.getElementsByTagName("body")[0]||p.body))b();if(!D){typeof p.addEventListener!=q&&p.addEventListener("DOMContentLoaded",b,false);if(l.ie&&l.win){p.attachEvent("onreadystatechange",
function(){if(p.readyState=="complete"){p.detachEvent("onreadystatechange",arguments.callee);b()}});u==top&&function(){if(!D){try{p.documentElement.doScroll("left")}catch(c){setTimeout(arguments.callee,0);return}b()}}()}l.wk&&function(){D||(/loaded|complete/.test(p.readyState)?b():setTimeout(arguments.callee,0))}();h(b)}}})();(function(){l.ie&&l.win&&window.attachEvent("onunload",function(){for(var c=H.length,e=0;e<c;e++)H[e][0].detachEvent(H[e][1],H[e][2]);c=S.length;for(e=0;e<c;e++)ca(S[e]);for(var g in l)l[g]=
null;l=null;for(var j in swfobject)swfobject[j]=null;swfobject=null})})();return{registerObject:function(c,e,g,j){if(l.w3&&c&&e){var k={};k.id=c;k.swfVersion=e;k.expressInstall=g;k.callbackFn=j;A[A.length]=k;E(c,false)}else j&&j({success:false,id:c})},getObjectById:function(c){if(l.w3)return r(c)},embedSWF:function(c,e,g,j,k,n,o,s,t,K){var T={success:false,id:e};if(l.w3&&!(l.wk&&l.wk<312)&&c&&e&&g&&j&&k){E(e,false);d(function(){g+="";j+="";var C={};if(t&&typeof t===w)for(var y in t)C[y]=t[y];C.data=
c;C.width=g;C.height=j;y={};if(s&&typeof s===w)for(var U in s)y[U]=s[U];if(o&&typeof o===w)for(var V in o)if(typeof y.flashvars!=q)y.flashvars+="&"+V+"="+o[V];else y.flashvars=V+"="+o[V];if(N(k)){U=F(C,y,e);C.id==e&&E(e,true);T.success=true;T.ref=U}else if(n&&G()){C.data=n;O(C,y,e,K);return}else E(e,true);K&&K(T)})}else K&&K(T)},switchOffAutoHideShow:function(){ea=false},ua:l,getFlashPlayerVersion:function(){return{major:l.pv[0],minor:l.pv[1],release:l.pv[2]}},hasFlashPlayerVersion:N,createSWF:function(c,
e,g){if(l.w3)return F(c,e,g)},showExpressInstall:function(c,e,g,j){l.w3&&G()&&O(c,e,g,j)},removeSWF:function(c){l.w3&&ca(c)},createCSS:function(c,e,g,j){l.w3&&da(c,e,g,j)},addDomLoadEvent:d,addLoadEvent:h,getQueryParamValue:function(c){var e=p.location.search||p.location.hash;if(e){if(/\?/.test(e))e=e.split("?")[1];if(c==null)return fa(e);e=e.split("&");for(var g=0;g<e.length;g++)if(e[g].substring(0,e[g].indexOf("="))==c)return fa(e[g].substring(e[g].indexOf("=")+1))}return""},expressInstallCallback:function(){if(Q){var c=
v(ba);if(c&&I){c.parentNode.replaceChild(I,c);if(R){E(R,true);if(l.ie&&l.win)I.style.display="block"}W&&W(aa)}Q=false}}}}(),SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};
...
a.cleanUp=function(b){try{if(this.movieElement&&typeof b.CallFunction==="unknown"){this.debug("Removing Flash functions hooks (this should only run in IE and should prevent memory leaks)");for(var d in b)try{if(typeof b[d]==="function")b[d]=null}catch(h){}}}catch(m){}window.__flash__removeCallback=function(f,i){try{if(f)f[i]=null}catch(r){}}};a.fileDialogStart=function(){this.queueEvent("file_dialog_start_handler")};
...
PandaUploader.createXRequestObject=function(){if(typeof XDomainRequest!="undefined")return new XDomainRequest;else if(typeof XMLHttpRequest!="undefined"){var b=new XMLHttpRequest;return"withCredentials"in b?b:null}else return null};PandaUploader.bind=function(b,d){return function(){console.log(d);var h=b[d];if(h)return h.apply(b,arguments);else typeof console!="undefined"&&console.debug("Not implemented: ",d)}};PandaUploader.alert=function(b){return alert(b)};
...
(function(){function b(f){this.options=f}function d(f){b.apply(this,[f])}function h(f){b.apply(this,[f])}function m(f){this.options=f;this.$p=jQuery("#"+this.options.upload_progress_id);this.$p.css("display","none");this.count=0}UPLOADING=0;STOP=1;jQuery.fn.checkPandaUploaderOptions=function(f,i){var r=this.parents("form")[0];if(f===undefined){PandaUploader.alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}if(i.upload_button_id===undefined){PandaUploader.alert("You have to specify the button id");
return false}if(this.size()==0){PandaUploader.alert("The jQuery element is empty. Method pandaUploader() cannot be executed");return false}if(!r){PandaUploader.alert("Could not find a suitable form. Please place the call to pandaUploader() after the form, or to be executed onload().");return false}if($(r).find("[name=submit], #submit").length!=0){PandaUploader.alert('An element of your video upload form is incorrect (most probably the submit button). Neither NAME nor ID can be set to "submit" on any field.');
return false}return true};jQuery.fn.pandaUploader=function(f,i,r){i=i===undefined?{}:i;if(!this.checkPandaUploaderOptions(f,i))return false;i=jQuery.extend({upload_filename_id:null,upload_progress_id:null,api_host:"api.pandastream.com",progress_handler:null,uploader_dir:"/panda_uploader",disable_submit_button:true,strategy:"upload_on_submit"},i);i.api_url=i.api_url||"http://"+i.api_host+"/v2";if(!i.progress_handler)i.progress_handler=new m(i);f=new PandaUploader.FlashWidget(this,f,i,r);r=null;switch(i.strategy){case "upload_on_submit":r=
d;break;case "upload_on_select":r=h;break;default:r=i.strategy}strategy=new r(i);strategy.setUploadWidget(f);f.setUploadStrategy(strategy);(i=jQuery("#"+i.upload_cancel_button_id))&&i.click(PandaUploader.bind(strategy,"onCancel"));return this};jQuery.fn.pandaHTML5Uploader=function(f,i){i=i===undefined?{}:i;if(!this.checkPandaUploaderOptions(f,i))return false;i=jQuery.extend({upload_filename_id:null,upload_progress_id:null,api_host:"api.pandastream.com",progress_handler:null,uploader_dir:"/panda_uploader",
disable_submit_button:true,strategy:"upload_on_submit"},i);i.api_url=i.api_url||"http://"+i.api_host+"/v2";if(!i.progress_handler)i.progress_handler=new m(i);f=new PandaUploader.HTML5Widget(this,f,i);var r=null;switch(i.strategy){case "upload_on_submit":r=d;break;case "upload_on_select":r=h;break;default:r=i.strategy}strategy=new r(i);strategy.setUploadWidget(f);f.setUploadStrategy(strategy);(i=jQuery("#"+i.upload_cancel_button_id))&&i.click(PandaUploader.bind(strategy,"onCancel"));return this};b.prototype=
{setUploadWidget:function(f){this.widget=f},disableSubmitButton:function(){$(this.getSubmitButton()).attr("disabled",true)},enableSubmitButton:function(){return $(this.getSubmitButton()).removeAttr("disabled")},getSubmitButton:function(){return $(this.widget.getForm()).find("input[type=submit]")},onwidgetload:function(){},onchange:function(){},onloadstart:function(){},onprogress:function(f){try{this.options.progress_handler&&this.options.progress_handler.setProgress(this.widget.getFile(),f.loaded,
f.total)}catch(i){}},onload:function(){},onerror:function(){},onabort:function(){},onsubmit:function(){}};d.prototype=new b;d.prototype.constructor=d;d.prototype.onchange=function(){var f=$("#"+this.options.upload_filename_id);if(f.size()!=0){f.val(this.widget.getFile().name);this.enableSubmitButton()}};d.prototype.onwidgetload=function(){$(this.widget.getForm()).submit(PandaUploader.bind(this,"onsubmit"));this.options.disable_submit_button&&this.disableSubmitButton()};d.prototype.onloadstart=function(){this.widget.disable();
this.options.progress_handler.reset();this.disableSubmitButton();this.options.progress_handler&&this.options.progress_handler.start(this.widget.getFile())};d.prototype.onreadystatechange=function(f){if(f.target.status=="200"&&f.target.responseText){this.widget.setValue(jQuery.parseJSON(f.target.responseText).id);this.widget.getForm().submit()}else console.log("onreadystatechange: status",f.target.status)};d.prototype.onerror=function(){$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset()};
d.prototype.onabort=function(){this.widget.cancel();this.widget.enable();$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset();this.options.disableSubmitButton&&this.disableSubmitButton()};d.prototype.onsubmit=function(){this.widget.start();return false};h.prototype=new b;h.prototype.constructor=h;h.prototype.onchange=function(){this.widget.start()};h.prototype.onloadstart=function(f,i){this.options.progress_handler.reset();this.disableSubmitButton();this.options.progress_handler&&
this.options.progress_handler.start(i)};h.prototype.onabort=function(){this.cancel();this.enable();$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset();this.options.disableSubmitButton&&this.disableSubmitButton()};h.prototype.onerror=function(){$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset()};h.prototype.onreadystatechange=function(f){if(f.target.status=="200"&&f.target.responseText){this.widget.setValue(jQuery.parseJSON(f.target.responseText).id);
this.enableSubmitButton()}else console.log("onreadystatechange: status",f.target.status)};m.prototype={start:function(f){this.count=0;if(this.$p.size()!=0){this.$p.find(".progress-inside").size()==0&&this.$p.append('<div class="progress-inside"></div>');this.progress=this.$p.find(".progress-inside");this.setProgress(f,0,f.size);this.$p.css("display","block");var i=this;this.timer=setInterval(function(){i.animateBarBg()},20)}},setProgress:function(f,i,r){if(this.progress){f=Math.ceil(i*100/r);$(this.progress).css("width",
f+"%")}},animateBarBg:function(){this.count++;var f=this.$p.css("background-position");f=f?f.split(" "):0;if(this.count==37){this.count=0;this.$p.css("background-position",f+36+"px 0px")}else this.$p.css("background-position",f-1+"px 0px")},reset:function(){clearInterval(this.timer);$(this.progress).css("width","0%");this.$p.css("display","none")}}})();
