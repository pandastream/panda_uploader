var a,swfobject=function(){function b(){if(!D){try{var c=p.getElementsByTagName("body")[0].appendChild(z("span"));c.parentNode.removeChild(c)}catch(e){return}D=true;c=L.length;for(var f=0;f<c;f++)L[f]()}}function d(c){if(D)c();else L[L.length]=c}function g(c){if(typeof u.addEventListener!=q)u.addEventListener("load",c,false);else if(typeof p.addEventListener!=q)p.addEventListener("load",c,false);else if(typeof u.attachEvent!=q)ga(u,"onload",c);else if(typeof u.onload=="function"){var e=u.onload;u.onload=
function(){e();c()}}else u.onload=c}function m(){Z?h():l()}function h(){var c=p.getElementsByTagName("body")[0],e=z(w);e.setAttribute("type",M);var f=c.appendChild(e);if(f){var i=0;(function(){if(typeof f.GetVariable!=q){var j=f.GetVariable("$version");if(j){j=j.split(" ")[1].split(",");k.pv=[parseInt(j[0],10),parseInt(j[1],10),parseInt(j[2],10)]}}else if(i<10){i++;setTimeout(arguments.callee,10);return}c.removeChild(e);f=null;l()})()}else l()}function l(){var c=A.length;if(c>0)for(var e=0;e<c;e++){var f=
A[e].id,i=A[e].callbackFn,j={success:false,id:f};if(k.pv[0]>0){var n=v(f);if(n)if(N(A[e].swfVersion)&&!(k.wk&&k.wk<312)){E(f,true);if(i){j.success=true;j.ref=s(f);i(j)}}else if(A[e].expressInstall&&G()){j={};j.data=A[e].expressInstall;j.width=n.getAttribute("width")||"0";j.height=n.getAttribute("height")||"0";if(n.getAttribute("class"))j.styleclass=n.getAttribute("class");if(n.getAttribute("align"))j.align=n.getAttribute("align");var o={};n=n.getElementsByTagName("param");for(var r=n.length,t=0;t<
r;t++)if(n[t].getAttribute("name").toLowerCase()!="movie")o[n[t].getAttribute("name")]=n[t].getAttribute("value");O(j,o,f,i)}else{P(n);i&&i(j)}}else{E(f,true);if(i){if((f=s(f))&&typeof f.SetVariable!=q){j.success=true;j.ref=f}i(j)}}}}function s(c){var e=null;if((c=v(c))&&c.nodeName=="OBJECT")if(typeof c.SetVariable!=q)e=c;else if(c=c.getElementsByTagName(w)[0])e=c;return e}function G(){return!Q&&N("6.0.65")&&(k.win||k.mac)&&!(k.wk&&k.wk<312)}function O(c,e,f,i){Q=true;W=i||null;aa={success:false,
id:f};var j=v(f);if(j){if(j.nodeName=="OBJECT"){I=J(j);R=null}else{I=j;R=f}c.id=ba;if(typeof c.width==q||!/%$/.test(c.width)&&parseInt(c.width,10)<310)c.width="310";if(typeof c.height==q||!/%$/.test(c.height)&&parseInt(c.height,10)<137)c.height="137";p.title=p.title.slice(0,47)+" - Flash Player Installation";i=k.ie&&k.win?"ActiveX":"PlugIn";i="MMredirectURL="+u.location.toString().replace(/&/g,"%26")+"&MMplayerType="+i+"&MMdoctitle="+p.title;if(typeof e.flashvars!=q)e.flashvars+="&"+i;else e.flashvars=
i;if(k.ie&&k.win&&j.readyState!=4){i=z("div");f+="SWFObjectNew";i.setAttribute("id",f);j.parentNode.insertBefore(i,j);j.style.display="none";(function(){j.readyState==4?j.parentNode.removeChild(j):setTimeout(arguments.callee,10)})()}F(c,e,f)}}function P(c){if(k.ie&&k.win&&c.readyState!=4){var e=z("div");c.parentNode.insertBefore(e,c);e.parentNode.replaceChild(J(c),e);c.style.display="none";(function(){c.readyState==4?c.parentNode.removeChild(c):setTimeout(arguments.callee,10)})()}else c.parentNode.replaceChild(J(c),
c)}function J(c){var e=z("div");if(k.win&&k.ie)e.innerHTML=c.innerHTML;else if(c=c.getElementsByTagName(w)[0])if(c=c.childNodes)for(var f=c.length,i=0;i<f;i++)!(c[i].nodeType==1&&c[i].nodeName=="PARAM")&&c[i].nodeType!=8&&e.appendChild(c[i].cloneNode(true));return e}function F(c,e,f){var i,j=v(f);if(k.wk&&k.wk<312)return i;if(j){if(typeof c.id==q)c.id=f;if(k.ie&&k.win){var n="";for(var o in c)if(c[o]!=Object.prototype[o])if(o.toLowerCase()=="data")e.movie=c[o];else if(o.toLowerCase()=="styleclass")n+=
...
Object.prototype[t]&&t.toLowerCase()!="movie"&&X(r,t,e[t]);j.parentNode.replaceChild(r,j);i=r}}return i}function X(c,e,f){var i=z("param");i.setAttribute("name",e);i.setAttribute("value",f);c.appendChild(i)}function ca(c){var e=v(c);if(e&&e.nodeName=="OBJECT")if(k.ie&&k.win){e.style.display="none";(function(){e.readyState==4?ha(c):setTimeout(arguments.callee,10)})()}else e.parentNode.removeChild(e)}function ha(c){if(c=v(c)){for(var e in c)if(typeof c[e]=="function")c[e]=null;c.parentNode.removeChild(c)}}
function v(c){var e=null;try{e=p.getElementById(c)}catch(f){}return e}function z(c){return p.createElement(c)}function ga(c,e,f){c.attachEvent(e,f);H[H.length]=[c,e,f]}function N(c){var e=k.pv;c=c.split(".");c[0]=parseInt(c[0],10);c[1]=parseInt(c[1],10)||0;c[2]=parseInt(c[2],10)||0;return e[0]>c[0]||e[0]==c[0]&&e[1]>c[1]||e[0]==c[0]&&e[1]==c[1]&&e[2]>=c[2]?true:false}function da(c,e,f,i){if(!(k.ie&&k.mac)){var j=p.getElementsByTagName("head")[0];if(j){f=f&&typeof f=="string"?f:"screen";if(i)Y=x=null;
if(!x||Y!=f){i=z("style");i.setAttribute("type","text/css");i.setAttribute("media",f);x=j.appendChild(i);if(k.ie&&k.win&&typeof p.styleSheets!=q&&p.styleSheets.length>0)x=p.styleSheets[p.styleSheets.length-1];Y=f}if(k.ie&&k.win)x&&typeof x.addRule==w&&x.addRule(c,e);else x&&typeof p.createTextNode!=q&&x.appendChild(p.createTextNode(c+" {"+e+"}"))}}}function E(c,e){if(ea){e=e?"visible":"hidden";if(D&&v(c))v(c).style.visibility=e;else da("#"+c,"visibility:"+e)}}function fa(c){return/[\\\"<>\.;]/.exec(c)!=
null&&typeof encodeURIComponent!=q?encodeURIComponent(c):c}var q="undefined",w="object",M="application/x-shockwave-flash",ba="SWFObjectExprInst",u=window,p=document,B=navigator,Z=false,L=[m],A=[],S=[],H=[],I,R,W,aa,D=false,Q=false,x,Y,ea=true,k=function(){var c=typeof p.getElementById!=q&&typeof p.getElementsByTagName!=q&&typeof p.createElement!=q,e=B.userAgent.toLowerCase(),f=B.platform.toLowerCase(),i=f?/win/.test(f):/win/.test(e);f=f?/mac/.test(f):/mac/.test(e);e=/webkit/.test(e)?parseFloat(e.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
...
a.unescapeFilePostParams=function(b){var d=/[$]([0-9a-f]{4})/i,g={},m;if(b!=undefined){for(var h in b.post)if(b.post.hasOwnProperty(h)){m=h;for(var l;(l=d.exec(m))!==null;)m=m.replace(l[0],String.fromCharCode(parseInt("0x"+l[1],16)));g[m]=b.post[h]}b.post=g}return b};a.testExternalInterface=function(){try{return this.callFlash("TestExternalInterface")}catch(b){return false}};a.flashReady=function(){var b=this.getMovieElement();if(b){this.cleanUp(b);this.queueEvent("swfupload_loaded_handler")}else this.debug("Flash called back ready but the flash movie can't be found.")};
a.cleanUp=function(b){try{if(this.movieElement&&typeof b.CallFunction==="unknown"){this.debug("Removing Flash functions hooks (this should only run in IE and should prevent memory leaks)");for(var d in b)try{if(typeof b[d]==="function")b[d]=null}catch(g){}}}catch(m){}window.__flash__removeCallback=function(h,l){try{if(h)h[l]=null}catch(s){}}};a.fileDialogStart=function(){this.queueEvent("file_dialog_start_handler")};
...
(function(b){var d=["swfupload_loaded_handler","file_queued_handler","file_queue_error_handler","file_dialog_start_handler","file_dialog_complete_handler","upload_start_handler","upload_progress_handler","upload_error_handler","upload_success_handler","upload_complete_handler","queue_complete_handler"],g=[];b.fn.swfupload=function(){var m=b.makeArray(arguments);return this.each(function(){var h;if(m.length==1&&typeof m[0]=="object"){h=b(this).data("__swfu");if(!h){var l=m[0],s=b(this);h=[];b.merge(h,
d);b.merge(h,g);b.each(h,function(O,P){var J=P.replace(/_handler$/,"").replace(/_([a-z])/g,function(F,X){return X.toUpperCase()});l[P]=function(){var F=b.Event(J);s.trigger(F,b.makeArray(arguments));return!F.isDefaultPrevented()}});b(this).data("__swfu",new SWFUpload(l))}}else if(m.length>0&&typeof m[0]=="string"){var G=m.shift();(h=b(this).data("__swfu"))&&h[G]&&h[G].apply(h,m)}})};b.swfupload={additionalHandlers:function(){if(arguments.length===0)return g.slice();else b(arguments).each(function(m,
h){b.merge(g,b.makeArray(h))})},defaultHandlers:function(){return d.slice()},getInstance:function(m){return b(m).data("__swfu")}}})(jQuery);function PandaUploader(){}PandaUploader.supportAjaxUpload=function(){var b=document.createElement("INPUT");b.type="file";return"files"in b};PandaUploader.supportAjaxProgressEvents=function(){return typeof XDomainRequest!="undefined"?true:typeof XMLHttpRequest!="undefined"?"withCredentials"in new XMLHttpRequest:null};
PandaUploader.supportHTML5Widget=function(){return PandaUploader.supportAjaxUpload()&&PandaUploader.supportAjaxProgressEvents()};PandaUploader.createXRequestObject=function(){if(typeof XDomainRequest!="undefined")return new XDomainRequest;else if(typeof XMLHttpRequest!="undefined"){var b=new XMLHttpRequest;return"withCredentials"in b?b:null}else return null};PandaUploader.getWidgetClass=function(){return PandaUploader.supportHTML5Widget()?PandaUploader.HTML5Widget:PandaUploader.FlashWidget};
PandaUploader.bind=function(b,d){return function(){var g=b[d];if(g)return g.apply(b,arguments)}};PandaUploader.alert=function(b){return alert(b)};PandaUploader.BaseWidget=function(b,d,g){this.query=b;this.signed_params=d;this.options=g};
PandaUploader.BaseWidget.prototype={setUploadStrategy:function(){throw"Unimplemented method setUploadStrategy()";},getForm:function(){throw"Unimplemented method getForm()";},getSignedParams:function(){return this.signed_params.call?this.signed_params():this.signed_params},start:function(){throw"Unimplemented method start()";},disable:function(){throw"Unimplemented method disable()";},enable:function(){throw"Unimplemented method enable()";},cancel:function(){throw"Unimplemented method cancel()";},
setValue:function(){throw"Unimplemented method setValue()";},getValue:function(){throw"Unimplemented method getValue()";}};
PandaUploader.FlashWidget=function(b,d,g,m){PandaUploader.BaseWidget.apply(this,[b,d,g]);m=m===undefined?{}:m;this.query.after('<span id="pandauploader_flashwidget_placeholder"></span>');this.swfupload=b.swfupload(jQuery.extend({upload_url:g.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:g.uploader_dir+"/swfupload.swf",button_image_url:g.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:"pandauploader_flashwidget_placeholder",
file_post_name:"file",debug:false},m))};PandaUploader.FlashWidget.prototype=new PandaUploader.BaseWidget;a=PandaUploader.FlashWidget.prototype;a.constructor=PandaUploader.FlashWidget;
a.setUploadStrategy=function(b){this.upload_strategy=b;this.swfupload.bind("swfuploadLoaded",PandaUploader.bind(b,"onwidgetload"));this.swfupload.bind("fileQueued",PandaUploader.bind(this,"fileQueued"));this.swfupload.bind("uploadStart",PandaUploader.bind(this,"uploadStart"));this.swfupload.bind("uploadProgress",PandaUploader.bind(this,"uploadProgress"));this.swfupload.bind("uploadSuccess",PandaUploader.bind(this,"uploadSuccess"));this.swfupload.bind("uploadError",PandaUploader.bind(b,"onerror"))};
a.fileQueued=function(b,d){this.file=d;this.upload_strategy.onchange()};a.uploadStart=function(){this.swfupload.data("__swfu").setPostParams(this.getSignedParams());this.upload_strategy.onloadstart()};a.uploadProgress=function(b,d,g,m){b.loaded=g;b.total=m;this.upload_strategy.onprogress(b)};a.uploadSuccess=function(b,d,g){this.upload_strategy.onreadystatechange({target:{status:"200",responseText:g}})};a.getFile=function(){return this.file};a.getForm=function(){return this.swfupload.parents("form").get(0)};
a.start=function(){return this.swfupload.swfupload("startUpload")};a.disable=function(){return this.swfupload.swfupload("setButtonDisabled",true)};a.enable=function(){return this.swfupload.swfupload("setButtonDisabled",false)};a.cancel=function(){return this.swfupload.swfupload("cancelUpload","",false)};a.setValue=function(b){return this.swfupload.val(b)};a.getValue=function(){return this.swfupload.val()};PandaUploader.HTML5Widget=function(b,d,g){PandaUploader.BaseWidget.apply(this,[b,d,g])};
PandaUploader.HTML5Widget.prototype=new PandaUploader.BaseWidget;a=PandaUploader.HTML5Widget.prototype;a.constructor=PandaUploader.HTML5Widget;
...
false);this.xhr.addEventListener("readystatechange",PandaUploader.bind(b,"onreadystatechange"),false);this.query.after('<input type="file" />');$(this.getField()).change(PandaUploader.bind(b,"onchange"));b.onwidgetload()};a.getForm=function(){return this.query.parents("form").get(0)};
...
d);this.xhr.send(b)};a.getFile=function(){return $(this.getField()).get(0).files[0]};a.setValue=function(b){return this.query.val(b)};a.disable=function(){$(this.getField()).attr("disabled",true)};a.enable=function(){$(this.getField()).removeAttr("disabled")};a.getField=function(){return this.query.next().get(0)};
(function(){function b(h){this.options=h}function d(h){b.apply(this,[h])}function g(h){b.apply(this,[h])}function m(h){this.options=h;this.$p=jQuery("#"+this.options.upload_progress_id);this.$p.css("display","none");this.count=0}UPLOADING=0;STOP=1;jQuery.fn.checkPandaUploaderOptions=function(h){var l=this.parents("form")[0];if(h===undefined){PandaUploader.alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}if(this.size()==0){PandaUploader.alert("The jQuery element is empty. Method pandaUploader() cannot be executed");
return false}if(!l){PandaUploader.alert("Could not find a suitable form. Please place the call to pandaUploader() after the form, or to be executed onload().");return false}if($(l).find("[name=submit], #submit").length!=0){PandaUploader.alert('An element of your video upload form is incorrect (most probably the submit button). Neither NAME nor ID can be set to "submit" on any field.');return false}return true};jQuery.fn.pandaUploader=function(h,l,s){l=l===undefined?{}:l;if(!this.checkPandaUploaderOptions(h,
l))return false;l=jQuery.extend({upload_progress_id:null,api_host:"api.pandastream.com",progress_handler:null,uploader_dir:"/panda_uploader",disable_submit_button:true,strategy:"upload_on_submit",widget:null},l);l.api_url=l.api_url||"http://"+l.api_host+"/v2";if(!l.progress_handler)l.progress_handler=new m(l);if(!l.widget)l.widget=PandaUploader.getWidgetClass();h=new l.widget(this,h,l,s);s=null;switch(l.strategy){case "upload_on_submit":s=d;break;case "upload_on_select":s=g;break;default:s=l.strategy}strategy=
new s(l);strategy.setUploadWidget(h);h.setUploadStrategy(strategy);(l=jQuery("#"+l.upload_cancel_button_id))&&l.click(PandaUploader.bind(strategy,"onCancel"));return this};b.prototype={setUploadWidget:function(h){this.widget=h},disableSubmitButton:function(){$(this.getSubmitButton()).attr("disabled",true)},enableSubmitButton:function(){return $(this.getSubmitButton()).removeAttr("disabled")},getSubmitButton:function(){return $(this.widget.getForm()).find("input[type=submit]")},onwidgetload:function(){},
onchange:function(){},onloadstart:function(){},onprogress:function(h){try{this.options.progress_handler&&this.options.progress_handler.setProgress(this.widget.getFile(),h.loaded,h.total)}catch(l){}},onload:function(){},onerror:function(){},onabort:function(){},onsubmit:function(){}};d.prototype=new b;d.prototype.constructor=d;d.prototype.onchange=function(){this.enableSubmitButton()};d.prototype.onwidgetload=function(){$(this.widget.getForm()).submit(PandaUploader.bind(this,"onsubmit"));this.options.disable_submit_button&&
this.disableSubmitButton()};d.prototype.onloadstart=function(){this.widget.disable();this.options.progress_handler.reset();this.disableSubmitButton();this.options.progress_handler&&this.options.progress_handler.start(this.widget.getFile())};d.prototype.onreadystatechange=function(h){var l=null;try{l=h.target.status}catch(s){return}if(l=="200"&&h.target.responseText){this.widget.setValue(jQuery.parseJSON(h.target.responseText).id);this.widget.getForm().submit()}};d.prototype.onerror=function(){this.options.progress_handler.reset()};
d.prototype.onabort=function(){this.widget.cancel();this.widget.enable();this.options.progress_handler.reset();this.options.disableSubmitButton&&this.disableSubmitButton()};d.prototype.onsubmit=function(){this.widget.start();return false};g.prototype=new b;g.prototype.constructor=g;g.prototype.onchange=function(){this.widget.start()};g.prototype.onloadstart=function(){this.options.progress_handler.reset();this.disableSubmitButton();this.options.progress_handler&&this.options.progress_handler.start(this.widget.getFile())};
g.prototype.onabort=function(){this.cancel();this.enable();this.options.progress_handler.reset();this.options.disableSubmitButton&&this.disableSubmitButton()};g.prototype.onerror=function(){this.options.progress_handler.reset()};g.prototype.onreadystatechange=function(h){var l=null;try{l=h.target.status}catch(s){return}if(l=="200"&&h.target.responseText){this.widget.setValue(jQuery.parseJSON(h.target.responseText).id);this.enableSubmitButton()}};m.prototype={start:function(h){this.count=0;if(this.$p.size()!=
0){this.$p.find(".progress-inside").size()==0&&this.$p.append('<div class="progress-inside"></div>');this.progress=this.$p.find(".progress-inside");this.setProgress(h,0,h.size);this.$p.css("display","block");var l=this;this.timer=setInterval(function(){l.animateBarBg()},20)}},setProgress:function(h,l,s){if(this.progress){h=Math.ceil(l*100/s);$(this.progress).css("width",h+"%")}},animateBarBg:function(){this.count++;var h=this.$p.css("background-position");h=h?h.split(" "):0;if(this.count==37){this.count=
0;this.$p.css("background-position",h+36+"px 0px")}else this.$p.css("background-position",h-1+"px 0px")},reset:function(){clearInterval(this.timer);$(this.progress).css("width","0%");this.$p.css("display","none")}}})();
