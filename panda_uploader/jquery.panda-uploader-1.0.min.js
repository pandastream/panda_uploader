...
false);this.xhr.addEventListener("readystatechange",PandaUploader.bind(this,"onreadystatechange"),false);this.query.after('<input type="file" />');jQuery(this.getField()).change(this.boundHandler("onchange"));this.triggerEvent("onwidgetload")};
