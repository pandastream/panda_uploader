...
a.enable=function(){return this.swfupload.swfupload("setButtonDisabled",false)};a.abort=function(){this.swfupload.swfupload("cancelUpload","",false);this.add_filename_field&&jQuery("#"+this.filename_field_id).val("");this.triggerEvent("onabort")};a.setValue=function(b){return this.swfupload.val(b)};a.getValue=function(){return this.swfupload.val()};
...
a.getField=function(){return this.query.next().get(0)};a.onerror=function(b){this.notifyError(b)};a.notifyError=function(b){if(!this.errorCalled){this.errorCalled=true;this.triggerEvent("onerror",[b,this.getFile()])}};
