var a,swfobject=function(){function b(){if(!F){try{var c=q.getElementsByTagName("body")[0].appendChild(B("span"));c.parentNode.removeChild(c)}catch(d){return}F=true;c=N.length;for(var g=0;g<c;g++)N[g]()}}function e(c){if(F)c();else N[N.length]=c}function j(c){if(typeof w.addEventListener!=s)w.addEventListener("load",c,false);else if(typeof q.addEventListener!=s)q.addEventListener("load",c,false);else if(typeof w.attachEvent!=s)ga(w,"onload",c);else if(typeof w.onload=="function"){var d=w.onload;w.onload=
function(){d();c()}}else w.onload=c}function r(){Z?n():f()}function n(){var c=q.getElementsByTagName("body")[0],d=B(y);d.setAttribute("type",O);var g=c.appendChild(d);if(g){var i=0;(function(){if(typeof g.GetVariable!=s){var k=g.GetVariable("$version");if(k){k=k.split(" ")[1].split(",");l.pv=[parseInt(k[0],10),parseInt(k[1],10),parseInt(k[2],10)]}}else if(i<10){i++;setTimeout(arguments.callee,10);return}c.removeChild(d);g=null;f()})()}else f()}function f(){var c=C.length;if(c>0)for(var d=0;d<c;d++){var g=
C[d].id,i=C[d].callbackFn,k={success:false,id:g};if(l.pv[0]>0){var o=x(g);if(o)if(P(C[d].swfVersion)&&!(l.wk&&l.wk<312)){G(g,true);if(i){k.success=true;k.ref=h(g);i(k)}}else if(C[d].expressInstall&&m()){k={};k.data=C[d].expressInstall;k.width=o.getAttribute("width")||"0";k.height=o.getAttribute("height")||"0";if(o.getAttribute("class"))k.styleclass=o.getAttribute("class");if(o.getAttribute("align"))k.align=o.getAttribute("align");var p={};o=o.getElementsByTagName("param");for(var t=o.length,v=0;v<
t;v++)if(o[v].getAttribute("name").toLowerCase()!="movie")p[o[v].getAttribute("name")]=o[v].getAttribute("value");u(k,p,g,i)}else{I(o);i&&i(k)}}else{G(g,true);if(i){if((g=h(g))&&typeof g.SetVariable!=s){k.success=true;k.ref=g}i(k)}}}}function h(c){var d=null;if((c=x(c))&&c.nodeName=="OBJECT")if(typeof c.SetVariable!=s)d=c;else if(c=c.getElementsByTagName(y)[0])d=c;return d}function m(){return!Q&&P("6.0.65")&&(l.win||l.mac)&&!(l.wk&&l.wk<312)}function u(c,d,g,i){Q=true;W=i||null;aa={success:false,
id:g};var k=x(g);if(k){if(k.nodeName=="OBJECT"){K=L(k);R=null}else{K=k;R=g}c.id=ba;if(typeof c.width==s||!/%$/.test(c.width)&&parseInt(c.width,10)<310)c.width="310";if(typeof c.height==s||!/%$/.test(c.height)&&parseInt(c.height,10)<137)c.height="137";q.title=q.title.slice(0,47)+" - Flash Player Installation";i=l.ie&&l.win?"ActiveX":"PlugIn";i="MMredirectURL="+w.location.toString().replace(/&/g,"%26")+"&MMplayerType="+i+"&MMdoctitle="+q.title;if(typeof d.flashvars!=s)d.flashvars+="&"+i;else d.flashvars=
i;if(l.ie&&l.win&&k.readyState!=4){i=B("div");g+="SWFObjectNew";i.setAttribute("id",g);k.parentNode.insertBefore(i,k);k.style.display="none";(function(){k.readyState==4?k.parentNode.removeChild(k):setTimeout(arguments.callee,10)})()}H(c,d,g)}}function I(c){if(l.ie&&l.win&&c.readyState!=4){var d=B("div");c.parentNode.insertBefore(d,c);d.parentNode.replaceChild(L(c),d);c.style.display="none";(function(){c.readyState==4?c.parentNode.removeChild(c):setTimeout(arguments.callee,10)})()}else c.parentNode.replaceChild(L(c),
c)}function L(c){var d=B("div");if(l.win&&l.ie)d.innerHTML=c.innerHTML;else if(c=c.getElementsByTagName(y)[0])if(c=c.childNodes)for(var g=c.length,i=0;i<g;i++)!(c[i].nodeType==1&&c[i].nodeName=="PARAM")&&c[i].nodeType!=8&&d.appendChild(c[i].cloneNode(true));return d}function H(c,d,g){var i,k=x(g);if(l.wk&&l.wk<312)return i;if(k){if(typeof c.id==s)c.id=g;if(l.ie&&l.win){var o="";for(var p in c)if(c[p]!=Object.prototype[p])if(p.toLowerCase()=="data")d.movie=c[p];else if(p.toLowerCase()=="styleclass")o+=
' class="'+c[p]+'"';else if(p.toLowerCase()!="classid")o+=" "+p+'="'+c[p]+'"';p="";for(var t in d)if(d[t]!=Object.prototype[t])p+='<param name="'+t+'" value="'+d[t]+'" />';k.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"'+o+">"+p+"</object>";S[S.length]=c.id;i=x(c.id)}else{t=B(y);t.setAttribute("type",O);for(o in c)if(c[o]!=Object.prototype[o])if(o.toLowerCase()=="styleclass")t.setAttribute("class",c[o]);else o.toLowerCase()!="classid"&&t.setAttribute(o,c[o]);for(var v in d)d[v]!=
Object.prototype[v]&&v.toLowerCase()!="movie"&&X(t,v,d[v]);k.parentNode.replaceChild(t,k);i=t}}return i}function X(c,d,g){var i=B("param");i.setAttribute("name",d);i.setAttribute("value",g);c.appendChild(i)}function ca(c){var d=x(c);if(d&&d.nodeName=="OBJECT")if(l.ie&&l.win){d.style.display="none";(function(){d.readyState==4?ha(c):setTimeout(arguments.callee,10)})()}else d.parentNode.removeChild(d)}function ha(c){if(c=x(c)){for(var d in c)if(typeof c[d]=="function")c[d]=null;c.parentNode.removeChild(c)}}
function x(c){var d=null;try{d=q.getElementById(c)}catch(g){}return d}function B(c){return q.createElement(c)}function ga(c,d,g){c.attachEvent(d,g);J[J.length]=[c,d,g]}function P(c){var d=l.pv;c=c.split(".");c[0]=parseInt(c[0],10);c[1]=parseInt(c[1],10)||0;c[2]=parseInt(c[2],10)||0;return d[0]>c[0]||d[0]==c[0]&&d[1]>c[1]||d[0]==c[0]&&d[1]==c[1]&&d[2]>=c[2]?true:false}function da(c,d,g,i){if(!(l.ie&&l.mac)){var k=q.getElementsByTagName("head")[0];if(k){g=g&&typeof g=="string"?g:"screen";if(i)Y=z=null;
if(!z||Y!=g){i=B("style");i.setAttribute("type","text/css");i.setAttribute("media",g);z=k.appendChild(i);if(l.ie&&l.win&&typeof q.styleSheets!=s&&q.styleSheets.length>0)z=q.styleSheets[q.styleSheets.length-1];Y=g}if(l.ie&&l.win)z&&typeof z.addRule==y&&z.addRule(c,d);else z&&typeof q.createTextNode!=s&&z.appendChild(q.createTextNode(c+" {"+d+"}"))}}}function G(c,d){if(ea){d=d?"visible":"hidden";if(F&&x(c))x(c).style.visibility=d;else da("#"+c,"visibility:"+d)}}function fa(c){return/[\\\"<>\.;]/.exec(c)!=
null&&typeof encodeURIComponent!=s?encodeURIComponent(c):c}var s="undefined",y="object",O="application/x-shockwave-flash",ba="SWFObjectExprInst",w=window,q=document,D=navigator,Z=false,N=[r],C=[],S=[],J=[],K,R,W,aa,F=false,Q=false,z,Y,ea=true,l=function(){var c=typeof q.getElementById!=s&&typeof q.getElementsByTagName!=s&&typeof q.createElement!=s,d=D.userAgent.toLowerCase(),g=D.platform.toLowerCase(),i=g?/win/.test(g):/win/.test(d);g=g?/mac/.test(g):/mac/.test(d);d=/webkit/.test(d)?parseFloat(d.replace(/^.*webkit\/(\d+(\.\d+)?).*$/,
"$1")):false;var k=!+"\u000b1",o=[0,0,0],p=null;if(typeof D.plugins!=s&&typeof D.plugins["Shockwave Flash"]==y){if((p=D.plugins["Shockwave Flash"].description)&&!(typeof D.mimeTypes!=s&&D.mimeTypes[O]&&!D.mimeTypes[O].enabledPlugin)){Z=true;k=false;p=p.replace(/^.*\s+(\S+\s+\S+$)/,"$1");o[0]=parseInt(p.replace(/^(.*)\..*$/,"$1"),10);o[1]=parseInt(p.replace(/^.*\.(.*)\s.*$/,"$1"),10);o[2]=/[a-zA-Z]/.test(p)?parseInt(p.replace(/^.*[a-zA-Z]+(.*)$/,"$1"),10):0}}else if(typeof w.ActiveXObject!=s)try{var t=
new ActiveXObject("ShockwaveFlash.ShockwaveFlash");if(t)if(p=t.GetVariable("$version")){k=true;p=p.split(" ")[1].split(",");o=[parseInt(p[0],10),parseInt(p[1],10),parseInt(p[2],10)]}}catch(v){}return{w3:c,pv:o,wk:d,ie:k,win:i,mac:g}}();(function(){if(l.w3){if(typeof q.readyState!=s&&q.readyState=="complete"||typeof q.readyState==s&&(q.getElementsByTagName("body")[0]||q.body))b();if(!F){typeof q.addEventListener!=s&&q.addEventListener("DOMContentLoaded",b,false);if(l.ie&&l.win){q.attachEvent("onreadystatechange",
function(){if(q.readyState=="complete"){q.detachEvent("onreadystatechange",arguments.callee);b()}});w==top&&function(){if(!F){try{q.documentElement.doScroll("left")}catch(c){setTimeout(arguments.callee,0);return}b()}}()}l.wk&&function(){F||(/loaded|complete/.test(q.readyState)?b():setTimeout(arguments.callee,0))}();j(b)}}})();(function(){l.ie&&l.win&&window.attachEvent("onunload",function(){for(var c=J.length,d=0;d<c;d++)J[d][0].detachEvent(J[d][1],J[d][2]);c=S.length;for(d=0;d<c;d++)ca(S[d]);for(var g in l)l[g]=
null;l=null;for(var i in swfobject)swfobject[i]=null;swfobject=null})})();return{registerObject:function(c,d,g,i){if(l.w3&&c&&d){var k={};k.id=c;k.swfVersion=d;k.expressInstall=g;k.callbackFn=i;C[C.length]=k;G(c,false)}else i&&i({success:false,id:c})},getObjectById:function(c){if(l.w3)return h(c)},embedSWF:function(c,d,g,i,k,o,p,t,v,M){var T={success:false,id:d};if(l.w3&&!(l.wk&&l.wk<312)&&c&&d&&g&&i&&k){G(d,false);e(function(){g+="";i+="";var E={};if(v&&typeof v===y)for(var A in v)E[A]=v[A];E.data=
c;E.width=g;E.height=i;A={};if(t&&typeof t===y)for(var U in t)A[U]=t[U];if(p&&typeof p===y)for(var V in p)if(typeof A.flashvars!=s)A.flashvars+="&"+V+"="+p[V];else A.flashvars=V+"="+p[V];if(P(k)){U=H(E,A,d);E.id==d&&G(d,true);T.success=true;T.ref=U}else if(o&&m()){E.data=o;u(E,A,d,M);return}else G(d,true);M&&M(T)})}else M&&M(T)},switchOffAutoHideShow:function(){ea=false},ua:l,getFlashPlayerVersion:function(){return{major:l.pv[0],minor:l.pv[1],release:l.pv[2]}},hasFlashPlayerVersion:P,createSWF:function(c,
d,g){if(l.w3)return H(c,d,g)},showExpressInstall:function(c,d,g,i){l.w3&&m()&&u(c,d,g,i)},removeSWF:function(c){l.w3&&ca(c)},createCSS:function(c,d,g,i){l.w3&&da(c,d,g,i)},addDomLoadEvent:e,addLoadEvent:j,getQueryParamValue:function(c){var d=q.location.search||q.location.hash;if(d){if(/\?/.test(d))d=d.split("?")[1];if(c==null)return fa(d);d=d.split("&");for(var g=0;g<d.length;g++)if(d[g].substring(0,d[g].indexOf("="))==c)return fa(d[g].substring(d[g].indexOf("=")+1))}return""},expressInstallCallback:function(){if(Q){var c=
x(ba);if(c&&K){c.parentNode.replaceChild(K,c);if(R){G(R,true);if(l.ie&&l.win)K.style.display="block"}W&&W(aa)}Q=false}}}}(),SWFUpload;if(SWFUpload==undefined)SWFUpload=function(b){this.initSWFUpload(b)};
...
(function(b){var e=["swfupload_loaded_handler","file_queued_handler","file_queue_error_handler","file_dialog_start_handler","file_dialog_complete_handler","upload_start_handler","upload_progress_handler","upload_error_handler","upload_success_handler","upload_complete_handler","queue_complete_handler"],j=[];b.fn.swfupload=function(){var r=b.makeArray(arguments);return this.each(function(){var n;if(r.length==1&&typeof r[0]=="object"){n=b(this).data("__swfu");if(!n){var f=r[0],h=b(this);n=[];b.merge(n,
e);b.merge(n,j);b.each(n,function(u,I){var L=I.replace(/_handler$/,"").replace(/_([a-z])/g,function(H,X){return X.toUpperCase()});f[I]=function(){var H=b.Event(L);h.trigger(H,b.makeArray(arguments));return!H.isDefaultPrevented()}});b(this).data("__swfu",new SWFUpload(f))}}else if(r.length>0&&typeof r[0]=="string"){var m=r.shift();(n=b(this).data("__swfu"))&&n[m]&&n[m].apply(n,r)}})};b.swfupload={additionalHandlers:function(){if(arguments.length===0)return j.slice();else b(arguments).each(function(r,
n){b.merge(j,b.makeArray(n))})},defaultHandlers:function(){return e.slice()},getInstance:function(r){return b(r).data("__swfu")}}})(jQuery);
(function(){function b(f,h,m){this.form=f;this.options=h;this.uploader=m}function e(f,h,m){b.apply(this,[f,h,m]);this.num_errors=this.num_pending=this.num_files=0;this.status=STOP}function j(f,h,m){b.apply(this,[f,h,m])}function r(f){this.options=f;this.$p=jQuery("#"+this.options.upload_progress_id);this.$p.css("display","none");this.count=0}function n(f,h){return function(){return f[h].apply(f,arguments)}}UPLOADING=0;STOP=1;jQuery.fn.pandaUploader=function(f,h,m){var u=this.parents("form")[0];if(f===
undefined){alert("There was an error setting up the upload form. (The upload parameters were not specified).");return false}h=h===undefined?{}:h;m=m===undefined?{}:m;if(h.upload_button_id===undefined){alert("You have to specify the button id");return false}if(this.size()==0){alert("The jQuery element is empty. Method pandaUploader() cannot be executed");return false}if(!u){alert("Could not find a suitable form. Please place the call to pandaUploader() after the form, or to be executed onload().");
return false}if($(u).find("[name=submit], #submit").length!=0){alert('An element of your video upload form is incorrect (most probably the submit button). Neither NAME nor ID can be set to "submit" on any field.');return false}h=jQuery.extend({upload_filename_id:null,upload_progress_id:null,api_host:"api.pandastream.com",progress_handler:null,uploader_dir:"/panda_uploader",disable_submit_button:true,strategy:"upload_on_submit"},h);h.api_url=h.api_url||"http://"+h.api_host+"/v2";if(!h.progress_handler)h.progress_handler=
new r(h);f=this.swfupload(jQuery.extend({upload_url:h.api_url+"/videos.json",file_size_limit:0,file_types:"*.*",file_types_description:"All Files",file_upload_limit:0,flash_url:h.uploader_dir+"/swfupload.swf",button_image_url:h.uploader_dir+"/choose_file_button.png",button_width:87,button_height:27,button_placeholder_id:h.upload_button_id,post_params:f,file_post_name:"file",debug:false},m));m=null;switch(h.strategy){case "upload_on_submit":m=e;break;case "upload_on_select":m=j;break;default:m=h.strategy}strategy=
new m(u,h,f);f.bind("swfuploadLoaded",n(strategy,"onLoad"));f.bind("fileQueued",n(strategy,"onFileQueued"));f.bind("uploadStart",n(strategy,"onStart"));f.bind("uploadProgress",n(strategy,"onProgress"));f.bind("uploadSuccess",n(strategy,"onSuccess"));f.bind("uploadError",n(strategy,"onError"));f.bind("uploadComplete",n(strategy,"onComplete"));(h=jQuery("#"+h.upload_cancel_button_id))&&h.click(n(strategy,"onCancel"));return f};b.prototype={disableSubmitButton:function(f){$(this.form).find("input[type=submit]").each(function(){$(this.form).attr("disabled",
f)})},onLoad:function(){this.uploader.parents("form").eq(0).submit(n(this,"onSubmit"));this.options.disable_submit_button&&this.disableSubmitButton(true)},onSubmit:function(){},onFileQueued:function(){},onStart:function(){},onProgress:function(){},onSuccess:function(){},onError:function(){},onComplete:function(){}};e.prototype=new b;e.prototype.constructor=e;e.prototype.onFileQueued=function(f,h){this.num_files++;this.num_pending++;f=$("#"+this.options.upload_filename_id);if(f.size()!=0){f.val(h.name);
this.disableSubmitButton(false)}};e.prototype.onSubmit=function(){if(this.num_files>0){this.uploader.swfupload("startUpload");return false}};e.prototype.onStart=function(f,h){this.status=UPLOADING;this.uploader.swfupload("setButtonDisabled",true);this.options.progress_handler.reset();this.disableSubmitButton(true);this.options.progress_handler&&this.options.progress_handler.start(h)};e.prototype.onCancel=function(f){this.uploader.swfupload("cancelUpload","",false);this.uploader.swfupload("setButtonDisabled",
false);$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset();this.num_errors=this.num_pending=this.num_files=0;this.options.disableSubmitButton&&this.disableSubmitButton(true);cancel_handler=options.cancel;this.uploader.status==UPLOADING&&cancel_handler&&cancel_handler(f);this.status=STOP};e.prototype.onProgress=function(f,h,m,u){try{this.options.progress_handler&&this.options.progress_handler.setProgress(h,m,u)}catch(I){}};e.prototype.onSuccess=function(f,h,m){this.uploader.val(eval("("+
m+")").id);this.num_pending--;(success_handler=this.options.success)&&success_handler(f,h,m)};e.prototype.onError=function(f,h,m,u){$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset();this.num_pending--;this.num_errors++;(error_handler=this.options.error)?error_handler(f,h,u):alert("There was an error uploading the file.\n\nHTTP error code "+u)};e.prototype.onComplete=function(f){if(this.num_files>0&&this.num_pending<=0&&this.num_errors<=0)if(this.uploader.val()){this.status=
STOP;(complete_handler=this.options.complete)?complete_handler(f):this.form.submit()}else alert("The video ID was not stored on the form")};j.prototype=new b;j.prototype.constructor=j;j.prototype.onFileQueued=function(){this.uploader.swfupload("startUpload")};j.prototype.onStart=function(f,h){this.options.progress_handler.reset();this.disableSubmitButton(true);this.options.progress_handler&&this.options.progress_handler.start(h)};j.prototype.onCancel=function(f){this.uploader.swfupload("cancelUpload",
"",false);this.uploader.swfupload("setButtonDisabled",false);$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset();this.options.disableSubmitButton&&this.disableSubmitButton(true);cancel_handler=options.cancel;this.uploader.status==UPLOADING&&cancel_handler&&cancel_handler(f)};j.prototype.onProgress=function(f,h,m,u){try{this.options.progress_handler&&this.options.progress_handler.setProgress(h,m,u)}catch(I){}};j.prototype.onSuccess=function(f,h,m){this.uploader.val(eval("("+
m+")").id);this.num_pending--;(success_handler=this.options.success)&&success_handler(f,h,m)};j.prototype.onError=function(f,h,m,u){$("#"+this.options.upload_filename_id).val("");this.options.progress_handler.reset();this.num_pending--;this.num_errors++;(error_handler=this.options.error)?error_handler(f,h,u):alert("There was an error uploading the file.\n\nHTTP error code "+u)};j.prototype.onComplete=function(f){if(this.uploader.val()){this.status=STOP;(complete_handler=this.options.complete)&&complete_handler(f)}else alert("The video ID was not stored on the form")};
r.prototype={start:function(f){this.count=0;if(this.$p.size()!=0){this.$p.find(".progress-inside").size()==0&&this.$p.append('<div class="progress-inside"></div>');this.progress=this.$p.find(".progress-inside");this.setProgress(f,0,f.size);this.$p.css("display","block");var h=this;this.timer=setInterval(function(){h.animateBarBg()},20)}},setProgress:function(f,h,m){if(this.progress){f=Math.ceil(h/m*100);$(this.progress).css("width",f+"%")}},animateBarBg:function(){this.count++;var f=this.$p.css("background-position");
