...
a.validateFileExtension=function(){var b=false,c=this.getFilename();jQuery.each(this.options.allowed_extensions,function(f,k){if((new RegExp("\\."+k+"$","i")).test(c))b=true});b||PandaUploader.alert("You did not select a video file. Please select a valid file.");return b};
