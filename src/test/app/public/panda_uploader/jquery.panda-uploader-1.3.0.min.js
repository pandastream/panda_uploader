...
b.name||b.fileName);"name"in b?this.xhr.send(b):this.xhr.sendAsBinary(b.getAsBinary())};a.abort=function(){PandaUploader.log("HTML5 widget: abort event");$(this.getField()).remove();this.createField();this.xhr.abort()};a.getFile=function(){return jQuery(this.getField()).find('input[type="file"]').get(0).files[0]};a.setValue=function(b){return this.query.val(b)};a.disable=function(){jQuery(this.getField()).attr("disabled",true)};a.enable=function(){jQuery(this.getField()).removeAttr("disabled")};
