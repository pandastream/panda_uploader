...
a.onabort=function(){this.cancel();this.enable();this.widget.options.progress_handler.reset()};a.onerror=function(){this.widget.options.progress_handler.reset()};a.onreadystatechange=function(b){var c=null;try{c=b.target.status}catch(f){return}c=="200"&&b.target.responseText&&this.widget.setValue(jQuery.parseJSON(b.target.responseText).id)};
