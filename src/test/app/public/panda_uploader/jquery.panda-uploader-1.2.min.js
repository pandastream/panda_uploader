...
a.validateFileSize=function(){var b=this.getFile().size||this.getFile().fileSize;console.log(this.options.file_size_limit,b);var c=this.options.file_size_limit||"5GB",f=b<PandaUploader.sizeInBytes(c);console.log(this.options.file_size_limit,b,PandaUploader.sizeInBytes(this.options.file_size_limit),f);f||PandaUploader.alert("The file you are trying to upload is too large. The limit is "+c);return f};PandaUploader.BaseStrategy=function(){};
